      ...
      <div className="bg-white p-8 rounded-lg shadow-md">
        ...
        <div className="mt-4 text-center">
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center w-full border border-gray-300 text-gray-700 font-medium py-2 px-4 rounded-md hover:bg-gray-50 disabled:opacity-50"
          >
